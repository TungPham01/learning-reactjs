                            ...
                            return (
                                <div className="todo-child mb-10" key={item.id}>
                                                ...
                                                <>
                                                    {
                                                        item.id === updateTodo.id
                                                            ?
                                                            <input type="text" className="mr-10" value={updateTodo.title} onChange={(event) => this.handleOnChangeEdit(event)} />
                                                            :
                                                            item.title
                                                    }
                                    ...
                                    </span>
                                    {
                                        isEmptyObj
                                            ?
                                        <button className='mr-10 edit' onClick={() => this.handleEdit(item)}>Edit</button>
                                        :
                                        <button className='mr-10 edit' onClick={() => this.handleOnClickUpdate(item, updateTodo)}>Save</button>
                                    }
